...
class _CustomerHomeScreenState extends State<CustomerHomeScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (customer != null) {
        Provider.of<CustomerOrderProvider>(
          context,
          listen: false,
        ).listenToCustomerOrders(customer.id);
      }
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    final notificationProvider = Provider.of<CustomerNotificationProvider>(
      context,
    );
    ...
    final firstName =
        fullName.isNotEmpty ? fullName.split(' ').first : 'العميل';
            ...
            Stack(
              ...
              children: [
                IconButton(
                  ...
                  tooltip: 'الإشعارات',
                  onPressed: () async {
                    final allowed = await FcmService.ensurePermissionWithDialog(
                      context,
                    );
              ...
              case 2:
                activeScreen = CartScreen(
                  ...
                  onGoToMenu: () {
                    setState(() {
                      _currentIndex =
                          0; // Switch to Menu tab seamlessly without page stacking
                    });
                  },
                );
                break;
              case 3:
                activeScreen = CustomerOrdersScreen(
                  scrollController: controller,
                );
                break;
              default:
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                storeProvider.closedReason ??
                                    'يسعدنا خدمتكم واستقبال طلباتكم في أوقات العمل الرسمية.',
                                style: AppFonts.cairoFont(
  ...
  Widget _buildOrdersNavItem(CustomerOrderProvider orderProvider) {
    ...
    final Color unselectedColor =
        isDark ? Colors.grey.shade400 : Colors.white.withAlpha(170);
                        ...
                        Positioned(
                          ...
                          child: IgnorePointer(
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: isDark ? AppColors.danger : Colors.white,
                                shape: BoxShape.circle,
                                boxShadow: [
                                  BoxShadow(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow:
                    isSelected
                        ? [
                          BoxShadow(
                            color: selectedColor.withAlpha(140),
                            blurRadius: 4,
                            spreadRadius: 0.5,
                          ),
                        ]
